  ...
  return(
      <footer className="footer">
            ...
            <div className="footer-social_media">
                <button><img width="12px" height="12px" src="/facebook.svg" alt=""/></button>
                <button><img width="12px" height="12px" src="/twitter.svg" alt=""/></button>
                <button><img width="12px" height="12px" src="/world.svg" alt=""/></button>
                <button><img width="12px" height="12px" src="/medium.svg" alt=""/></button>
                <button><img width="12px" height="12px" src="/telegram.svg" alt=""/></button>
            </div>
